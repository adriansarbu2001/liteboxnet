...
class LiteBoxNetLoss(torch.nn.Module):
    ...
    def forward(self, re, gt):
        ...
        sin_loss_1_v1       = F.mse_loss(re_sin_1, gt_sin_1, reduction='none')
        sin_loss_1_v2       = F.mse_loss(re_sin_2, gt_sin_1, reduction='none')
        sin_loss_2_v1       = F.mse_loss(re_sin_2, gt_sin_2, reduction='none')
        sin_loss_2_v2       = F.mse_loss(re_sin_1, gt_sin_2, reduction='none')
        cos_loss_1_v1       = F.mse_loss(re_cos_1, gt_cos_1, reduction='none')
        cos_loss_1_v2       = F.mse_loss(re_cos_2, gt_cos_1, reduction='none')
        cos_loss_2_v1       = F.mse_loss(re_cos_2, gt_cos_2, reduction='none')
        cos_loss_2_v2       = F.mse_loss(re_cos_1, gt_cos_2, reduction='none')
        ...
        trig_loss_v1        = self._trig_w * (sin_loss_1_v1 + sin_loss_2_v1 + cos_loss_1_v1 + cos_loss_2_v1)
        trig_loss_v2        = self._trig_w * (sin_loss_1_v2 + sin_loss_2_v2 + cos_loss_1_v2 + cos_loss_2_v2)
